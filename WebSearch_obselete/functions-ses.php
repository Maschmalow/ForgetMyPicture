<?PHP
    ...
    function scrape_google($search_string, $page, $local_data)
    {
        ...
        if ($page == 0)
        {
            if ($test_100_resultpage)
            {
                $url = "http://$google_ip/search?q=$search_string&hl=$h&safe=off&tbm=ischl&ie=utf-8&as_qdr=all&aq=t&rls=org:mozilla:us:official&client=firefox&num=100&filter=$filter";
            } else
            {
                $url = "http://$google_ip/search?q=$search_string&hl=$hl&safe=off&tbm=isch&ie=utf-8&as_qdr=all&aq=t&rls=org:mozilla:us:official&client=firefox&num=10&filter=$filter";
            }
        } else
        {
            ...
            {
                $num = $page * 100;
                $url = "http://$google_ip/search?q=$search_string&hl=$hl&safe=off&tbm=isch&ie=utf-8&as_qdr=all&aq=t&rls=org:mozilla:us:official&client=firefox&start=$num&num=100&filter=$filter";
            } else
            {
                $num = $page * 10;
                $url = "http://$google_ip/search?q=$search_string&hl=$hl&safe=off&tbm=isch&ie=utf-8&as_qdr=all&aq=t&rls=org:mozilla:us:official&client=firefox&start=$num&num=10&filter=$filter";
            }
        }
