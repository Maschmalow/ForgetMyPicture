...
$session = curl_init();
curl_setopt($session, CURLOPT_URL, 'http://maschmalow.ddns.net/FMP/lr_eudpa.html');
/*
curl_setopt($session, CURLOPT_URL, 'https://support.google.com/legal/contact/lr_eudpa?product=websearch&hl=en'); //ici selon la langue/pays de l'utilisateur on modifiera le "en"
*/
curl_setopt($session, CURLOPT_POST, TRUE);
curl_setopt($session, CURLOPT_POSTFIELDS, $post_str);
